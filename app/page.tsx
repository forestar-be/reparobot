...
const structuredData = {
  ...
  description: 'Spécialiste robot tondeuse Husqvarna & Gardena en Belgique. Entretien, achat, réparation et installation par des experts certifiés.',
  ...
  mainEntity: {
    ...
    description: 'Spécialiste en entretien, achat et réparation de robots tondeuses Husqvarna et Gardena en Belgique',
    url: 'https://reparobot.be',
    logo: 'https://reparobot.be/images/logo/logo-70x70.png',
    image: 'https://reparobot.be/images/robot-tondeuse-husqvarna-gardena-belgique.jpg',
  ...
  hasPart: [
    {
      ...
      description: 'Entretien, réparation et installation de robots tondeuses Husqvarna et Gardena',
    ...
    },
    {
      ...
      name: 'À propos',
      description: 'Notre expertise en robots tondeuses et notre engagement qualité',
        ...
        <Suspense
          fallback={
            <div className="flex h-screen items-center justify-center bg-gradient-to-br from-primary-50 to-white">
              <div className="animate-pulse text-primary-500">Chargement...</div>
            </div>
          }
        >
          <Hero
