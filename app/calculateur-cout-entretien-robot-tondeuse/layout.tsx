...
export const metadata: Metadata = {
  ...
  description:
    "Estimez instantanément les coûts d'entretien de votre robot tondeuse. Quiz de diagnostic précis, tarifs transparents basés sur la taille du terrain, la fréquence d'utilisation et le type de maintenance.",
  keywords: [
  ...
  openGraph: {
    title:
      'Calculateur Coût Entretien Robot Tondeuse | Diagnostic & Estimation',
    description:
...
const structuredData = {
  ...
  description:
    "Calculez vos coûts d'entretien robot tondeuse selon la taille du terrain, la fréquence d'utilisation, le type de terrain et les accessoires utilisés",
  featureList: [
