...
interface ROICalculateurProps {
  theme: Theme;
}

const ROICalculateur = ({ theme }: ROICalculateurProps): JSX.Element => {
        ...
        <div className="section">
          ...
          <div className={`form-group ${errors.moyenneTonteParSaison ? 'error' : ''}`}>
            ...
            <input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setMoyenneTonteParSaison(e.target.value)}
              required
              min="1"
              step="1"
              ref={moyenneTonteRef}
        ...
        <div className="section">
          ...
          <div className={`form-group ${errors.usageRobotParSaison ? 'error' : ''}`}>
            ...
            <input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setUsageRobotParSaison(e.target.value)}
              required
              min="1"
              step="1"
              ref={usageRobotRef}
        ...
        <div className="section">
          ...
          <div className={`form-group ${errors.dureeAnnees ? 'error' : ''}`}>
            ...
            <input
              ...
              placeholder="Ex: 5"
              value={dureeAnnees}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setDureeAnnees(Number(e.target.value))}
              required
              min="1"
              step="1"
              ref={dureeRef}
